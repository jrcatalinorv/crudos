...
while($results = $stmt2 -> fetch())
{
  echo '<tr>
			<td>'.$results["email"].'</td>
			<td>'.$results["usuario"].'</td>
			<td>'.$results["nombre"].' '.$results["apellido"].'</td>
				<td> 
				<button type="button" class="btn btn-xs btn-warning btn-block btn-flat itemEdit"  
			...
			title="Editar" ><i class="fas fa-edit"></i> Editar </button> </td>
				<td> 
				<button type="button" class="btn btn-xs btn-primary btn-block btn-flat rstPass"  
			codigo="'.$results['email'].'"  
			usuario="'.$results['usuario'].'"
			title="Clave por defecto nombre de usuario" ><i class="fas fa-sync-alt"></i> Resetear clave </button> </td>
	   </tr>';	
}	
?>           
 </tfoot>
      ...
      <div class="modal-content">
            ...
            <div class="modal-body"> 
				<div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <input id="modalCode" type="text" class="form-control" maxlength="15" />
                    </div>
                  </div>
				  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Usuario: </label> 
                    <div class="col-sm-10">
                       <input id="modalUser" type="text" class="form-control" maxlength="15" />
                    </div>
                  </div>
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <input id="modalFName" type="text" class="form-control"  maxlength="15" />
                    </div>
                  </div>
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <input id="modalLName" type="text" class="form-control" maxlength="15" />
                    </div>
                  </div>			
            </div>
      ...
      <div class="modal-content">
            ...
            <div class="modal-body"> 
				<div class="form-group row">
                    <label class="col-sm-2 col-form-label">Código: </label>
                    <div class="col-sm-10">
                       <input id="modalCodeEdit" type="text" class="form-control" maxlength="15" />
                    </div>
                  </div>
				  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Usuario: </label>
				  ...
				  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nombre: </label>
                    <div class="col-sm-10">
                       <input id="modalFNameEdit" type="text" class="form-control" maxlength="15" />
                    </div>
                  </div>
				  ...
				  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Apellido: </label>
                    <div class="col-sm-10">
                       <input id="modalLNameEdit" type="text" class="form-control" maxlength="15" />
                    </div>
                  </div>	
            </div>
            <div class="modal-footer justify-content-between">
...
$('.assetsList').on('click','button.rstPass',function(){
 $.getJSON('model/auditor_actualizar_pass.php',{
		usuario: $(this).attr('usuario')
	 },function(data){
		switch(data['ok']){
			case 0: toastr.error('ERROR! No se pudo guardar los cambios: '+ data['err']); break;
			case 1: toastr.success('Los datos fueron actualizados con exito.'); break;
		}
	}); 
